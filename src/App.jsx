...
// ⚠️ THAY địa chỉ này sau khi deploy contract
const CONTRACT_ADDRESS = '0x00000000000000000000000000000000000000';
// USDC ERC20 interface trên Arc Testnet (6 decimals)
...
export default function App() {
  ...
  async function handleCreateOffer(e) {
    ...
    try {
      ...
      const loanAmountParsed = ethers.parseUnits(form.loanAmount || '0', 6);
